...
Gestor de descargas de vídeo y audio para Windows y macOS. Funciona con YouTube y más de 1.000 webs gracias a [yt-dlp](https://github.com/yt-dlp/yt-dlp).
...
- Motor actualizable desde la propia app.
...
| `packaging/` | Iconos, componentes, PyInstaller, instalador y DMG |
